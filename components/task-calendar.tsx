...
function toLocalDateString(date: Date | string): string {
  ...
  // Usa os valores locais sem converter para UTC
        ...
        .map((task) => {
          ...
          return {
            ...
            start: task.startDate
              ? toLocalDateString(task.startDate)
              ...
              <div className="space-y-2">
                ...
                {selectedTask.startDate && (
                  <div>
                    ...
                    <p className="text-xs text-dark-primary mt-0.5">
                      {toLocalDateString(selectedTask.startDate).split("-").reverse().join("/")}
                    </p>
                  </div>
                )}
                ...
                {selectedTask.dueDate && (
                  <div>
                    ...
                    <p className="text-xs text-dark-primary mt-0.5">
                      {toLocalDateString(selectedTask.dueDate).split("-").reverse().join("/")}
                    </p>
                  </div>
                )}
              </div>
